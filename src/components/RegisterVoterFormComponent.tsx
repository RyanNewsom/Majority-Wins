        ...
        <tr>
          <td> <label>
            ...
            <td> <input type="text" name="state"
                  value={voterForm.state} onChange={change} />
          </td>
          </tr>
          <tr>
            <td> <label>
            ...
            </td><td> <input type="text" name="birthDate"
          ...
          <tr>
            ...
            </td><td> <input type="number" name="phone"
                    value={voterForm.phone} onChange={change} />
            </td>
          </tr>
          <tr>
            <button type="button" onClick={setupSubmitVoter(props, voterForm, resetVoterForm)}>{props.buttonText}</button>
          </tr>
          </table>
      </form>
    );
